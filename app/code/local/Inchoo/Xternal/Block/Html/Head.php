...
class Inchoo_Xternal_Block_Html_Head extends Diglin_UIOptimization_Block_Optimize_Head
{
    ...
    protected function _separateOtherHtmlHeadElements(&$lines, $itemIf, $itemType, $itemParams, $itemName, $itemThe)
    {
        ...
        switch ($itemType) {
            ...
            case 'link_rel':
           	...
           	case 'external_js':
                $lines[$itemIf]['other_js'][] = sprintf('<script type="text/javascript" src="%s" %s></script>', $href, $params);
                break;
                            
          	case 'external_css':
                $lines[$itemIf]['other_css'][] = sprintf('<link rel="stylesheet" type="text/css" href="%s" %s/>', $href, $params);
                break;
        }
    }
    ...
    public function getCssJsHtml()
    {
        ...
        foreach ($lines as $if => $items) {
            ...
            if (!empty($items['other_css'])) {
                $html .= $this->_prepareOtherHtmlHeadElements($items['other_css']) . "\n";
            }
            ...
            if (!empty($items['other_js'])) {
                $html .= $this->_prepareOtherHtmlHeadElements($items['other_js']) . "\n";
            }
